...
struct max_heap *cria(int n);
void corrige_heap_descendo(struct max_heap *, int);
void mostra(int *, int);
...
struct max_heap *cria(int n)
{
    struct max_heap *heap = (struct max_heap *)malloc(sizeof(struct max_heap));
...
void corrige_heap_descendo(struct max_heap *heap, int x)
{
